use {
    ...
    stratum::{
        Authorize, ClientReconnect, Configure, Difficulty, Extranonce, Id, JobId, MAX_MESSAGE_SIZE,
        MerkleNode, Message, Nbits, Nonce, Notify, Ntime, PrevHash, SetDifficulty, StratumError,
