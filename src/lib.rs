use {
    ...
    bitcoin::{
        Address, Amount, Block, BlockHash, CompactTarget, FeeRate, Network, OutPoint, Psbt,
        ScriptBuf, Sequence, Target, Transaction, TxIn, TxOut, Txid, VarInt, Witness,
        address::NetworkUnchecked,
        block::{self, Header},
        blockdata::constants::{COINBASE_MATURITY, DIFFCHANGE_INTERVAL, TARGET_BLOCK_SPACING},
