...
async fn status(State(metatron): State<Arc<Metatron>>) -> Json<PoolStatus> {
    Json(PoolStatus {
        ...
        idle: metatron.idle(),
        accepted_shares: metatron.accepted_shares(),
        rejected_shares: metatron.rejected_shares(),
        ...
        accepted_work: metatron.accepted_work(),
        rejected_work: metatron.rejected_work(),
        ph_days: metatron.accepted_work().into(),
...
async fn user(
    ...
    Ok(Json(UserDetail {
        ...
        accepted_shares: user.accepted_shares(),
