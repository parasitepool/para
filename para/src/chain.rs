...
#[derive(Default, clap::ValueEnum, Copy, Clone, Debug, PartialEq, Serialize, Deserialize)]
...
impl Chain {
    ...
    pub(crate) fn join_with_data_dir(self, data_dir: impl AsRef<path::Path>) -> PathBuf {
        match self {
